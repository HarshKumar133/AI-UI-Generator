        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-end">
          {plans.map((plan, idx) => (
            ...
            >
              ...
              <div className="relative w-full h-[240px] mb-8 flex flex-col items-start justify-start">
                <div className="flex items-start">
                  <span className={`text-4xl font-black mt-4 mr-2 ${plan.featured ? "text-white/40" : "text-white/20"}`}>$</span>
                  <motion.span
                    initial={{ y: 20, opacity: 0 }}
                    whileInView={{ y: 0, opacity: 1 }}
                    className="text-[80px] md:text-[120px] font-black leading-[0.8] tracking-tighter block"
                  >
                    {plan.price.charAt(0)}
                  </motion.span>
                </div>
                <motion.span
                  ...
                  className="text-[80px] md:text-[120px] font-black leading-[0.8] tracking-tighter block ml-[2rem] md:ml-[3.5rem]"
                >
                  {plan.price.slice(1)}
                </motion.span>
              </div>
