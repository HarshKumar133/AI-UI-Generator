      ...
      <div className="container relative z-10 mx-auto px-4 text-center">
        ...
        >
          ...
          <div className="relative flex items-center bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-2 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] ring-1 ring-brand-dark/5 focus-within:ring-brand-red/20 transition-all">
            ...
            />
            <Button size="icon" onClick={handleSubmit} disabled={isLoading || !prompt.trim()} className="h-14 w-14 rounded-full bg-brand-red hover:bg-brand-red/90 text-white shrink-0 shadow-lg shadow-brand-red/20 transition-transform active:scale-95">
